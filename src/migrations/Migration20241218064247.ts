...
export class Migration20241218064247 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "users" ("id" serial primary key, "created_at" bigint not null, "updated_at" bigint not null, "email" varchar(255) not null, "username" varchar(255) not null, "password" varchar(255) not null, "role_id" int not null, "bio" varchar(255) null, "profile" varchar(255) null, "phone" varchar(255) null, "wallet_id" int null, "cart_id" int not null);`);
    ...
    this.addSql(`create table "products" ("id" serial primary key, "created_at" bigint not null, "updated_at" bigint not null, "title" varchar(50) not null, "slug" varchar(255) not null, "inventory" int not null, "describtion" text not null, "user_id" int not null, "price" numeric(10,2) not null, "category_id" int not null);`);
    ...
    this.addSql(`alter table "users" add constraint "users_wallet_id_foreign" foreign key ("wallet_id") references "wallets" ("id") on update cascade on delete set null;`);
  ...
  override async down(): Promise<void> {
    this.addSql(`alter table "Product-Attribute" drop constraint "Product-Attribute_attribute_id_foreign";`);

    this.addSql(`alter table "notifications_users" drop constraint "notifications_users_notification_id_foreign";`);
    ...
    this.addSql(`alter table "wallets" drop constraint "wallets_user_id_foreign";`);
    ...
    this.addSql(`alter table "notifications_users" drop constraint "notifications_users_user_id_foreign";`);
    ...
    this.addSql(`alter table "Product-Attribute" drop constraint "Product-Attribute_product_id_foreign";`);
    ...
    this.addSql(`drop table if exists "notifications_users" cascade;`);
